...
export default function BudgedAddScreen() {
    ...
    const onSend = async () => {
        await addDoc(collection(dbContext, 'budgeds'), newItem);
        navigation.goBack();
    };
    ...
    return <>
        <Screen>
            <ScrollView >
                ...
                <Button title="Add Budged" onPress={onSend} />
            </ScrollView>
        </Screen>
    </>;
}
...
const styles = StyleSheet.create({
    ...
    input:{
        padding:5,
        fontSize:20,backgroundColor:"gray", margin:5
    }
});